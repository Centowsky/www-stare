...
<head>
    <title>MDP ŁAWY - Twój profil</title>
    <meta charset="utf-8">
        ...
        <nav class="navbar navbar-expand-sm navbar-dark sticky-top bg-primary sticky">		
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav navbar-right mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="twoj-profil">Twój profil</a>
                    </li>
            ...
            <div class="row">
                <div class="col-md-6">
                    <?php
                        ...
                        echo "<div class='progress'><div class='progress-bar bg-warning' role='progressbar' style='min-height: 2vh; width: ".$_SESSION['liczba_obecnosci']/$ile * $procent."%' aria-valuenow='".$_SESSION['liczba_obecnosci']."' aria-valuemin='0' aria-valuemax='".$ile."'></div></div>";
                        echo $_SESSION['liczba_obecnosci']."/".$ile."<br>";
                    ?>      
                </div>
                <div class="col-md-6">
                <?php
                        ...
                        echo "<div class='progress'><div class='progress-bar bg-success' role='progressbar' style='min-height: 2vh; width: ".$_SESSION['punkty']/$ile * $procent."%' aria-valuenow='".$_SESSION['punkty']."' aria-valuemin='0' aria-valuemax='".$ile."'></div></div>";
                        echo $_SESSION['punkty']."/".$ile."<br>";
                    ?>  
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row bg-white border border-danger rounded">
                        <?php   
                            $kto = $_SESSION['kto2'];
                            $sql = "SELECT * FROM aktywnosc WHERE kto = '$kto'";
                            $result = mysqli_query($db, $sql);
                            while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                            echo "<div class='row'><div class='col-md-6'>".$row['kategoria']."</div><div class='col-md-3'>".$row['data_dodania']."</div><div class='col-md-3'>".$row['ilosc_punktow']."</div></div><hr>";
                            }
                        ?>
                    </div>
                </div>
