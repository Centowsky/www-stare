...
<head>
    ...
    <meta name="keywords" content="OSP, OSP-Ławy, osp-lawy, osp lawy, osp ławy, KSRG, MDP, MDP Ławy, Ławy, młodzieżowa drużyna pożarnicza, ochrona przeciwpożarowa, ratownictwo techniczne, myślibórz, powiat myśliborski, gmina myślibórz, galeria">
...
<body>
    ...
    <article>
        ...
        <div class="col-md-10 col-centered bg-dark" style="margin-top: 3%;">
            <p class="h2 text-danger">!Galeria w budowie!</p>
            <p class="h1 text-primary">Foldery</p>
            <div class="row">
                <div class="col-md-3">
                    <a class="link" href="/gallery/index.php">
