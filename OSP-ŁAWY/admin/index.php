...
<head>
    <title>Panel Administratora | Zarzadzanie</title>
    <meta charset="utf-8">
...
<body>
    ...
    <article>
        <div class="col-md-10 col-centered panel bg-ciemny border-jasny">
            <p class="h2 text-danger">KATEGORIE</p><br>
            <div class="row">
                <div class="col-md-6">
                    <a href="https://osp-lawy.pl/admin/uzytkownicy"><button class="btn btn-info">Użytkownicy</button></a>
                </div>
                <div class="col-md-6">
                    <a href="https://osp-lawy.pl/admin/posty"><button class="btn btn-info">Posty</button></a>
                </div>
                <div class="col-md-6">
                    <a href="https://osp-lawy.pl/admin/ksiazka-wyjazdow"><button class="btn btn-info">Książka wyjazdów</button></a>
                </div>
                <div class="col-md-6">
                    <a href="https://osp-lawy.pl/admin/aktywnosc"><button class="btn btn-info">Aktywność</button></a>
                </div>
                <div class="col-md-6">
                    <a href="https://osp-lawy.pl/admin/obencosci"><button class="btn btn-info">Obecności</button></a>
                </div>
                <div class="col-md-6">
                    <a href="https://osp-lawy.pl/admin/memy"><button class="btn btn-info">Memy</button></a>
                </div>
            </div>
        </div>
        ...
        <!--<div class="container-fluid">
            <div class="row">
                <div class="col-md-10 col-centered">
                    <div class="admin dodaj-uzytkownika">
                        <form action="panel-admina" method="post">
                            <h2 class="text-warning">Dodaj uzytkownika</h2>
                                                    ...
                                                    if ($rowcount == 0) {
                                                        if ((strlen($login) > 3 ) && (strlen($login) < 21 ))  {
                                                            if ((strlen($haslo) > 3 ) && (strlen($haslo) < 25 ))  {
                                                                ...
                                                                echo "<script>";
                                                                echo "location.href='panel-admina'";
                                                                echo "</script>";
                                                            } else {
                ...
                <div class="col-md-10 col-centered">
                    <div class="admin zmien-haslo">
                        <form method="post" action="panel-admina">
                            <h2 class="text-warning">Zmien haslo</h2>
                            <div class="input-group">
                ...
                <div class="col-md-10 col-centered">
                    <div class="admin zmien-email">
                        <form method="post" action="panel-admina">
                            <h2 class="text-warning">Zmien email</h2>
                            <div class="input-group">
                                <select name="uzytkownik" class="form-control" required>
                                    <option disabled selected value="">Wybierz uzytkownika</option>
                                        <?php
                ...
                <div class="col-md-10 col-centered">
                    <div class="admin zmien-punkty">
                        <form method="post" action="panel-admina">
                            <h2 class="text-warning">Zmien punkty</h2>
                            <div class="input-group">
                                <select name="uzytkownik" class="form-control" required>
                                    <option disabled selected value="">Wybierz uzytkownika</option>
                                        <?php
                ...
                <div class="col-md-10 col-centered">
                    <div class="admin zmien-range">
                        <form method="post" action="panel-admina">
                            <h2 class="text-warning">Zmien range</h2>
                            <div class="input-group">
                                <select name="uzytkownik" class="form-control" required>
                                    <option disabled selected value="">Wybierz uzytkownika</option>
                                        <?php
                ...
                <div class="col-md-10 col-centered">
                    <div class="admin zmien-l-obecnosci">
                        <form method="post" action="panel-admina">
                            <h2 class="text-warning">Zmien liczbe obecnosci</h2>
                            <div class="input-group">
                                <select name="uzytkownik" class="form-control" required>
                                    <option disabled selected value="">Wybierz uzytkownika</option>
                                        <?php
                ...
                <div class="col-md-10 col-centered">
                    <div class="admin zmien-sort">
                        <form method="post" action="panel-admina">
                            <h2 class="text-warning">Zmien sort</h2>
                            <div class="input-group">
                                <select name="uzytkownik" class="form-control" required>
                                    <option disabled selected value="">Wybierz uzytkownika</option>
                                        <?php
                ...
                <div class="col-md-10 col-centered">
                    <div class="admin dodaj-wyjazd">
                        <form method="post" action="panel-admina" enctype="multipart/form-data">
