...
--
-- Host: localhost
-- Czas generowania: 05 Maj 2019, 13:59
...
CREATE TABLE `aktywnosc` (
  ...
  `ilosc_punktow` varchar(255) COLLATE utf8_polish_ci NOT NULL
...
(1, 'PoĹźar', 'Nasza jednostka zostaĹa zadysponowana do poĹźaru budynku mieszkalnego w miejscowoĹci GĹazĂłw.  SiĹy i Ĺrodki PSP MyĹlibĂłrz, OSP Ĺawy, OSP Sulimierz', 'brak', '2019-03-15'),
(2, 'PoĹźar', 'Nasza jednostka zostaĹa zadysponowana do poĹźaru samochodu w miejscowoĹci Ĺawy. \r\nSiĹy i Ĺrodki PSP MyĹlibĂłrz, OSP Ĺawy.', 'brak', '2019-03-21'),
(3, 'PoĹźar', 'Nasza jednostka zostaĹa zadysponowana do poĹźaru magazynu butli z gazem w miejscowoĹci MyĹlibĂłrz.\r\nSiĹy i Ĺrodki: PSP MyĹlibĂłrz, KW PSP Szczecin, OSP Ĺawy, OSP Sulimierz, OSP RĂłw , OSP OtanĂłw.', 'brak', '2019-03-22');
...
CREATE TABLE `obecnosci` (
  `id` int(255) NOT NULL,
  `data_spotkania` varchar(255) COLLATE utf8_polish_ci NOT NULL,
  `Jakub_Centkiewicz` varchar(255) COLLATE utf8_polish_ci NOT NULL,
  `Tomasz_Wierucki` varchar(255) COLLATE utf8_polish_ci NOT NULL,
  `Kacper_Bartnicki` varchar(255) COLLATE utf8_polish_ci NOT NULL,
  `Kamil_Szurko` varchar(255) COLLATE utf8_polish_ci DEFAULT NULL,
  `Olivier_Dubicki` varchar(255) COLLATE utf8_polish_ci DEFAULT NULL,
  `Wiktor_Jakubowski` varchar(255) COLLATE utf8_polish_ci DEFAULT NULL,
  `Jakub_Czekala` varchar(255) COLLATE utf8_polish_ci DEFAULT NULL,
  `Bartlomiej_Urbanowski` varchar(255) COLLATE utf8_polish_ci DEFAULT NULL,
  `Gabriela_ZagĂłrska` varchar(255) COLLATE utf8_polish_ci DEFAULT NULL,
  `Sebastian_ZagĂłrski` varchar(255) COLLATE utf8_polish_ci DEFAULT NULL,
  `Dominik_Domanski` varchar(255) COLLATE utf8_polish_ci DEFAULT NULL,
  `Wojciech_Jakubowski` varchar(255) COLLATE utf8_polish_ci DEFAULT NULL,
  `Ryszard_Wierucki` varchar(255) COLLATE utf8_polish_ci DEFAULT NULL,
  `Oliwia_Jakubowska` varchar(255) COLLATE utf8_polish_ci NOT NULL,
  `Dawid_Bartnicki` varchar(255) COLLATE utf8_polish_ci NOT NULL,
  `Dawid_Baran` varchar(255) COLLATE utf8_polish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE `ogloszenia` (
  ...
  `tekst` varchar(1000) COLLATE utf8_polish_ci NOT NULL,
...
INSERT INTO `ogloszenia` (`id`, `tytul`, `tekst`, `data`) VALUES
(1, 'OGLOSZENIE!', 'Email kontaktowy (bĹÄdy, pytania): <br><b>cento@osp-lawy.pl</b>', '2019-02-16'),
(2, 'UWAGA!', 'ZarzÄd Ochotniczej StraĹźy PoĹźarnej w Ĺawach informuje,\r\nĹźeÂ wÂ dniu 09.03.2019r. (sobota) o godzinie 17. 00 w Ĺwietlicy\r\nwiejskiej wÂ Ĺawach odbÄdzie siÄ Zebranie\r\nSprawozdawcze zaÂ 2018 rok.', '2019-03-02');
...
CREATE TABLE `osoby` (
  ...
  `ranga` varchar(255) COLLATE utf8_polish_ci NOT NULL,
  `punkty` int(255) NOT NULL,
  `liczba_obecnosci` int(255) NOT NULL,
  `sort` varchar(255) COLLATE utf8_polish_ci NOT NULL,
...
(1, 'centkiewiczj', 'e0b46e3a5632cfa4220859d7aaa0ec1f', 'cent7331@gmail.com', 'Jakub', 'Centkiewicz', 'Administrator', 20, 15, 'Koszarowka, Dres, Buty', 'Administrator strony', 1, 1, 1),
...
(3, 'bartnickik', 'f543a18b3d463905da3cbf7254e4b0e9', 'kacp3rb@wp.pl', 'Kacper', 'Bartnicki', 'Ognik: Strazak Opiekun', 20, 19, '', 'Ognik: Strazak Opiekun', 1, 1, 0),
...
(9, 'zagorskag', 'e10adc3949ba59abbe56e057f20f883e', 'Do ustawienia', 'Gabriela', 'ZagĂłrska', 'Kandydat: Florek', 5, 12, 'Koszulka, Dres', 'Brak', 1, 0, 0),
(10, 'zagorskis', '2ff65e2f5f6b9c81e452e8584b4426ed', 'Do ustawienia', 'Sebastian', 'ZagĂłrski', 'Kandydat: Florek', 35, 17, 'Koszulka, Dres', 'Brak', 1, 0, 0),
(11, 'domanskid', '759163a8097d95e146d397f47b917f4e', 'Do ustawienia', 'Dominik', 'Domanski', 'Kandydat: Florek', 30, 11, '', 'Brak', 1, 0, 0),
...
INSERT INTO `posty` (`id`, `tytul`, `tresc`, `zdjecie`, `data`) VALUES
(1, 'Zebranie', 'ZarzÄd Ochotniczej StraĹźy PoĹźarnej w Ĺawach informuje, Ĺźe w dniu 09.03.2019 r. (sobota) o godzinie 17. 00 w Ĺwietlicy wiejskiej w Ĺawach odbÄdzie siÄ Zebranie Sprawozdawcze za 2018 rok. ', '../img/posty/5c855dc69bba63.57159615.png', '2019-03-03'),
(2, 'Zebranie sprawozdawcze za rok 2018', 'Dnia 09.03.2019 r. w Ĺwietlicy wiejskiej odbyĹo siÄ Walne Zebranie Sprawozdawcze za 2018 r. Ochotniczej StraĹźy PoĹźarnej w Ĺawach .\r\n\r\nSerdeczne podziÄkowania dla Stowarzyszenia PrzyjaciĂłĹ Ĺaw za przygotowany poczÄstunek.', '../img/posty/5c855e028b0121.23604880.jpg', '2019-03-10'),
(3, 'OstrzeĹźenie Pogodowe', 'Ostrzenie pogodowe dotyczÄce silnych wiatrĂłw.', '../img/posty/5c8b99e69e7180.05708828.png', '2019-03-15'),
(4, 'Plebiscyt na JednostkÄ Roku', 'Witamy serdecznie w zwiÄzku z nominacjÄ naszej jednostki w plebiscycie Jednostka Roku 2018, prosimy o wsparcie nas w tym konkursie za pomocÄ Waszych gĹosĂłw. Pozdrawiamy OSP Ĺawy.\r\nLink do plebiscytu <a href=\"https://gs24.pl/p/kandydat/osp-lawy%2C509871/#sms-plebiscyty\" target=\"_blank\">LINK</a>', '../img/posty/5c9682ad51cc07.46904051.png', '2019-03-23'),
(5, 'Szkolenie BHP', 'Dnia 30.03.2019 o godz. 9 w budynku 1 Maja odbedzie sie szkolenie BHP dla strazakow OSP Lawy', 'brak', '2019-03-27');
...
CREATE TABLE `wpisy` (
  `id` int(255) NOT NULL,
  `tekst` varchar(120) COLLATE utf8_polish_ci NOT NULL,
  `podpis` varchar(20) COLLATE utf8_polish_ci NOT NULL,
  `data` varchar(255) COLLATE utf8_polish_ci NOT NULL,
  `sprawdzone` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
