                    ...
                    <table class="table table-striped table-secondary">
                        ...
                        <tbody>
                            <?php
                                // POPRAWIC TABULATORY 
                                $who = $_SESSION['id'];
                                $sql = "SELECT DISTINCT wyjazdy.tytul, wyjazdy.data_start, wyjazdy.godziny FROM wyjazdy, obsada WHERE obsada.kierowca = $who || obsada.dowodca =  $who || obsada.ratownik1 = $who || obsada.ratownik2 = $who || obsada.ratownik3 = $who || obsada.ratownik4 = $who AND obsada.id_wyjazdy = wyjazdy.id_wyjazdy LIMIT 7"; 
